...
class TransformerEncoderLayer(nn.Module):
    def __init__(self, hidden, num_heads, fcn_hidden, dropout=0.0, causal=False):
        ...
        # Intializing all the layers of our neural net
        self.attention = MultiHeadSelfAttention(input_size=hidden , hidden= hidden , num_heads= num_heads , causal=causal, dropout=dropout)
...
class TransformerEncoder(nn.Module):
    ...
    def _add_positions(self, sequence_tensor):
        ...
        return sequence_tensor + self.pos_emb(positions)
        # YOUR CODE ENDS HERE
...
class TransformerLM(nn.Module):
    def __init__(self, num_layers, hidden, num_heads, fcn_hidden, vocab_size, max_seq_len, dropout=0.1):
        ...
        self.encoder = TransformerEncoder(
            ...
            fcn_hidden=fcn_hidden, vocab_size=vocab_size, max_seq_len= max_seq_len,
