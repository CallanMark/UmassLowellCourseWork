...
def preprocess_function(
    ...
    # The loop adds a beginning of sequence (BOS) token to decoder_input_ids and an end of sequence token (EOS) to labels whcih shifts the target sequence
    # The targe_tokenizer uses max_length = max_seq_length-1 to leave space for the BOS token
    # END OF YOUR ANSWER
    decoder_input_ids = []
    labels = []
    ...
    # We do this so the model predicts the next token based on the previous ones , this alligns 'decoder_input_ids' with 'labels'
    # END OF YOUR ANSWER
